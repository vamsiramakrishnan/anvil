 ...
 * risk). Antigravity `hooks.json` is deferred; see the design doc. (ADK plugins
 * were dropped — a per-language port of the rules in Python/TS/Go is needless
 * drift against the one JS core; ADK apps use the runtime + MCP annotations.)
 */
