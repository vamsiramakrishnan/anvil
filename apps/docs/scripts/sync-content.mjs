...
const PAGES = [
  ...
  { src: "docs/simulation-and-backtesting.md", dest: "concepts/simulation-and-backtesting.md", order: 6 },
  { src: GLOSSARY_SRC, dest: "concepts/glossary.md", order: 7, title: "Glossary" },
  {
  ...
  { src: "docs/SOURCE_FORMATS.md", dest: "guides/source-formats.md", order: 5 },
  { src: "docs/CI.md", dest: "guides/ci.md", order: 6 },
  { src: "docs/TROUBLESHOOTING.md", dest: "guides/troubleshooting.md", order: 7 },
  { src: "skills/anvil/reference/commands.md", dest: "guides/commands.md", order: 8 },
