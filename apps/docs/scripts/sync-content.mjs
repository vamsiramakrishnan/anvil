...
const PAGES = [
  ...
  { src: "docs/refinement-sdk.md", dest: "guides/refinement-sdk.md", order: 5 },
  { src: "docs/legacy-inventory.md", dest: "guides/legacy-inventory.md", order: 6 },
  { src: "docs/legacy-refinement.md", dest: "guides/legacy-refinement.md", order: 7 },
  { src: "docs/legacy-sdk.md", dest: "guides/legacy-sdk.md", order: 8 },
  { src: "docs/SOURCE_FORMATS.md", dest: "guides/source-formats.md", order: 9 },
  { src: "docs/CI.md", dest: "guides/ci.md", order: 10 },
  { src: "docs/TROUBLESHOOTING.md", dest: "guides/troubleshooting.md", order: 11 },
  { src: "skills/anvil/reference/commands.md", dest: "guides/commands.md", order: 12 },
